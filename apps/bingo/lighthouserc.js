...
const appConfig = performanceConfig.apps.bingo || {};
  ...
  ci: {
    collect: {
      ...
      url: [
        ...
        'http://localhost:3000/play',     // Presenter view
        'http://localhost:3000/display',  // Audience view
      ],
      ...
      settings: {
        ...
        // Bingo is typically used on facility WiFi
        throttling: {
    ...
    assert: {
      assertions: {
        ...
        'cumulative-layout-shift': [
          'error', // CLS is critical for game display
