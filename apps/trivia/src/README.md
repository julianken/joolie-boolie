...
- `components/`: UI grouped by presenter/audience/ui/pwa.
- `hooks/`: App-specific hooks (game, sync, audio, theme, timer).
- `lib/`: Pure logic and helpers (engine, questions, sync utilities).
