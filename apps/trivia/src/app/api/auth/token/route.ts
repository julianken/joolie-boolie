...
export async function POST(request: NextRequest) {
  try {
    ...
    cookieStore.set('trivia_access_token', tokens.access_token, {
      httpOnly: true,
    ...
    if (tokens.refresh_token) {
      cookieStore.set('trivia_refresh_token', tokens.refresh_token, {
        httpOnly: true,
        secure: process.env.NODE_ENV === 'production',
        sameSite: 'lax',
    ...
    cookieStore.set('trivia_user_id', tokens.user.id, {
