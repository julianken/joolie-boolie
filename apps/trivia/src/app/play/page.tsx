        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4">
            ...
            <button
              ...
              className="hidden sm:flex min-w-[44px] min-h-[44px] items-center justify-center rounded-lg
            ...
            <button
              ...
              className="hidden md:flex min-w-[44px] min-h-[44px] items-center justify-center rounded-lg
                text-muted-foreground hover:text-foreground hover:bg-muted/30
                transition-colors focus:outline-none focus:ring-2 focus:ring-primary"
          ...
          <div className="mt-4 md:mt-6 bg-orange-500/10 border border-orange-500/30 rounded-xl p-3 md:p-4 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
              <div className="flex items-center gap-3 md:gap-4">
                {/* Pause icon */}
                <div className="min-w-[44px] min-h-[44px] md:w-12 md:h-12 rounded-full bg-orange-500/20 flex items-center justify-center flex-shrink-0">
                  <svg
