...
test.describe('Trivia Dual-Screen Synchronization', () => {
  test.describe('Initial Connection', () => {
    test('presenter shows sync ready status before display opens', async ({ page }) => {
    ...
    test('display shows waiting state initially', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
  ...
  test.describe('Changes in Presenter Reflect in Display', () => {
    test('question displayed on presenter syncs to display', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
    ...
    test('game status changes sync to display', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
    ...
    test('question navigation syncs display index', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
    ...
    test('pause state syncs to display', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
    ...
    test('emergency pause blanks display', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
  ...
  test.describe('Score Updates Sync Correctly', () => {
    test('team scores sync to display scoreboard', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
    ...
    test('multiple teams score updates sync correctly', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
  ...
  test.describe('Round Completion and Progression', () => {
    test('round completion syncs scoreboard to display', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
    ...
    test('next round transition syncs to display', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
  ...
  test.describe('Timer Sync', () => {
    test('timer state syncs to display', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
  ...
  test.describe('Connection Resilience', () => {
    ...
    test('can reopen display after closing', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
    ...
    test('display receives state on reconnect', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
  ...
  test.describe('Theme Sync', () => {
    test('theme changes sync from presenter to display', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
  ...
  test.describe('Multiple Display Sessions', () => {
    test('opening second display works correctly', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
  ...
  test.describe('Sync Message Types', () => {
    test('STATE_UPDATE message syncs game state', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
    ...
    test('REQUEST_SYNC triggers state refresh', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
  ...
  test.describe('Edge Cases', () => {
    test('rapid state changes sync correctly', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
    ...
    test('handles display opened before teams added', async ({ page, context }) => {
      await page.goto('/play');
      await waitForHydration(page);
