...
test.describe('Bingo Presenter View', () => {
  ...
  test('displays bingo board with B-I-N-G-O columns', async ({ page }) => {
  ...
  test('displays keyboard shortcuts reference', async ({ page }) => {
  ...
  test('shows ball counter at zero initially', async ({ page }) => {
  ...
  test('can toggle auto-call setting', async ({ page }) => {
  ...
  test('displays current ball after calling', async ({ page }) => {
    // Call a ball
    const rollButton = page.getByRole('button', { name: /roll|call|start/i }).first();
    await rollButton.click();
  ...
  test('board updates when ball is called', async ({ page }) => {
  ...
  test('can pause and resume the game', async ({ page }) => {
  ...
  test('undo removes the last called ball', async ({ page }) => {
  ...
  test('reset clears all called balls', async ({ page }) => {
